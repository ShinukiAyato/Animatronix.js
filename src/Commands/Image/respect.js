...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            aliases: ['jailed'],
            category: "📸Image",
            description: "make the mentioned user's avatar respect",
            usage: "[mention]",
            ncat: 'Image'
        });
    }
    async run (message) {
        ...
        let buffer = await AmeAPI.generate("missionpassed", { url: user.user.displayAvatarURL({ format: "png", size: 512, dynamic: false }) });
