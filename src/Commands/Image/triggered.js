...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            aliases: ['trigger'],
            category: "📸Image",
            description: "make the mentioned user's avatar triggered",
            usage: "[mention]",
            ncat: 'Image'
        });
    }
    async run (message) {
        ...
        let buffer = await AmeAPI.generate("triggered", { url: user.user.displayAvatarURL({ format: "png", size: 512, dynamic: false }) });
