...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            aliases: ['tobecontinued', 'tbc'],
            category: "📸Image",
            description: "make the mentioned user's avatar tobecontinue",
            usage: "[mention]",
            ncat: 'Image'
        });
    }
    async run (message) {
        ...
        let buffer = await AmeAPI.generate("tobecontinued", { url: user.user.displayAvatarURL({ format: "png", size: 512, dynamic: false }) });
