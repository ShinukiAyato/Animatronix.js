...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            aliases: ['adddevs', 'adddeveloper', 'adddevelopers'],
    ...
    async run(message, args) {
            ...
            try{
                ...
                if(developers) return message.channels.send('That username is already a developer of Animatronix!');
                Devs.findOne({
                    userID: xid
                }, (err, dev) => {
                    ...
                    if(!dev){
                        new Devs({
                            userID: xid,
                        }).save().then(message.channel.send('The userID you have mention is now a Developer of Animatronix!'));
                    }
                })
            }
            catch(e){
